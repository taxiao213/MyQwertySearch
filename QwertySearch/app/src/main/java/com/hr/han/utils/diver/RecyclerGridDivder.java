...
public class RecyclerGridDivder extends RecyclerView.ItemDecoration {
    ...
    public RecyclerGridDivder(int space) {
        this.space = space;
    }

    public RecyclerGridDivder(int space, int color) {
        this.space = space;
        this.color = color;
        mPaint = new Paint();
    ...
    public RecyclerGridDivder(int space, int color, int type) {
        this.space = space;
        this.color = color;
    ...
    public RecyclerGridDivder(int space, Drawable mDivider) {
        this.space = space;
